...
FOSSLight Source Scanner는 pip3를 이용하여 설치할 수 있습니다. [python 3.6 + virtualenv](https://fosslight.org/fosslight-guide/scanner/etc/guide_virtualenv.html) 환경에서 설치할 것을 권장합니다.
