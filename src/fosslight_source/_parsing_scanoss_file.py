...
def parsing_extraInfo(scanned_result: List[ScanItem]) -> List[List[str]]:
    scanoss_extra_info = []
...
def parsing_scanResult(scanoss_report: Dict[str, List[Dict[str, Any]]], path_to_scan: str="", path_to_exclud: List[str]=[]) -> List[ScanItem]:
    scanoss_file_item = []
