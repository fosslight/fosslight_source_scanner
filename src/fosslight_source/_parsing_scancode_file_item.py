...
def get_error_from_header(header_item: List[Dict[str, List[str]]]) -> Tuple[bool, str]:
    has_error = False
    str_error = ""
    key_error = "errors"
...
def parsing_scancode_32_earlier(scancode_file_list: List[Dict[str, Any]], has_error: bool =False) -> Tuple[bool, List[ScanItem], List[str], Dict[str, MatchedLicense]]:
    rc = True
    msg = []
    scancode_file_item = []
...
def split_spdx_expression(spdx_string: str) -> List[str]:
    license = []
...
def parsing_scancode_32_later(scancode_file_list: List[Dict[str, Any]], has_error: bool=False) -> Tuple[bool, List[ScanItem], List[str], Dict[str, MatchedLicense]]:
    rc = True
    msg = []
    scancode_file_item = []
    license_list = {}  # Key :[license]+[matched_text], value: MatchedLicense()
...
def parsing_file_item(scancode_file_list: List[Dict[str, Any]], has_error: bool, need_matched_license: bool=False) -> Tuple[bool, List[ScanItem], List[str], Dict[str, MatchedLicense]]:
